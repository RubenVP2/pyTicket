...
CREATE TABLE ticket (
  ...
  date_ticket TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
INSERT INTO ticket (client_id, date_ticket, sujet_ticket, description_ticket, etat_ticket)
 VALUES
   ...
   (5, '2012-09-23 14:59:07', 'Serveur indisponible', "Serveur indisponible depuis coupure de courant, le site web est indisponible", 'en cours de résolution'),
   (5, '2020-11-10 14:59:07', "Fibre non performante", "L'ordinateur du stagiaire ne peut pas se connecter au réseau interne", 'résolu');
